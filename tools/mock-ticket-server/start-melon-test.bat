...
:: Chrome 실행 - Melon 도메인을 localhost:8080으로 리다이렉트
start "" "%CHROME_PATH%" ^
...
echo ============================================
echo  테스트 방법:
echo  1. Chrome에서 Melon Mock 페이지가 열립니다
echo  2. KillRiceMonkey 프로그램을 시작하세요
echo  3. Melon 템플릿 선택 후 자동화를 실행하세요
echo     - 관람일: 2026.04.11
echo     - 시간: 18:00
echo  4. 프로그램이 날짜/시간/예매를 순서대로 처리합니다
echo  5. 대기열 팝업 %QUEUE_SECONDS%초 대기
echo  6. 캡차 입력 후 구역 선택 대기 (수동 클릭)
echo  7. 좌석 자동 선택 및 완료
echo ============================================
echo.
