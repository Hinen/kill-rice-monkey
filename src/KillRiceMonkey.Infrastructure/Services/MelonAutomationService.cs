...
public sealed class MelonAutomationService : IMelonAutomationService, IAsyncDisposable
{
    ...
    private readonly ILogger<MelonAutomationService> _logger;
    ...
    public MelonAutomationService(
        ILogger<MelonAutomationService> logger,
